...
const Panel = ({ open, setOpen, id, Icon, title, imgSrc, description }) => {
  ...
  return (
    <>
      <button
        className="bg-gradient-to-r from-purple-700 via-purple-500 to-purple-300 hover:bg-slate-50 transition-colors p-3 border-r-[1px] border-b-[1px] border-slate-200 flex flex-row-reverse lg:flex-col justify-end items-center gap-4 relative group"
        onClick={() => setOpen(id)}
      >
        <span
          style={{
          ...
          className="hidden lg:block text-xl  rotate-180 text-white font-bold group-hover:text-slate-900 transition-colors"
        >
          {title}
        </span>
